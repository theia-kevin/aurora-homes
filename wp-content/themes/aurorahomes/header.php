...
<head>
    ...
    <meta property='og:image' content='<?php echo get_theme_file_uri( '/images/header_resized.jpg' ); ?>'/>
...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<header data-aos="fade-down" data-aos-once="true" id="header" class="fixed z-50 inset-0 px-[120px] h-[80px] hidden xl:flex items-center justify-between py-16 transition-all duration-300">
...
<header data-aos="fade-down" data-aos-once="true" id="header-mobile" class="mobile w-full px-[30px] fixed z-50 inset-0 h-[80px] flex xl:hidden items-center justify-between transition-all duration-300" x-data="{ sidebarOpen: false }" @keydown.window.escape="sidebarOpen = false">
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
        <img class="object-contain h-[50px]" src="<?php echo get_theme_file_uri( '/images/cropped-cropped-Asset-1-2.png' ); ?>" alt="">
    </a>
    ...
    <div class="fixed inset-0" x-show="sidebarOpen" style="display: none;">
        ...
        <div class="relative h-screen w-full flex flex-1 flex-col ml-auto pt-[100px] bg-aurora-blue-02" x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="-translate-y-full" x-transition:enter-end="translate-y-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-y-0" x-transition:leave-end="-translate-y-full">
