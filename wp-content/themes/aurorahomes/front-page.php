...
get_header();
?>
    <div class="relative h-[650px] xl:h-[950px] mb-[50px] xl:mb-[100px] bg-cover bg-no-repeat" style="background-image: url('<?php echo get_theme_file_uri( '/images/header_resized.jpg' ); ?>');">
    ...
    <div class="mb-[100px]" data-aos="fade-up" data-aos-once="true">
        <div class="container mx-auto px-4">
            <div class="flex flex-col">
                <p class="font-foco-bold text-[24px] text-aurora-blue-03 uppercase">Our Work</p>
                <p class="font-foco-black text-[50px] leading-[60px] text-aurora-blue-04 uppercase pb-[20px] ">Projects</p>
                <div class="flex flex-wrap pb-[20px]">
                    <a class="inline-block font-foco-light text-[16px] text-white bg-aurora-blue-03 border-[5px] border-aurora-blue-03 rounded-full py-[5px] px-[30px] self-start transition-all duration-300 hover:transform hover:translate-y-1 hover:-translate-x-1 hover:shadow-inner hover:border-aurora-blue-02 cursor-pointer mr-[15px] my-[5px]"
                        href="<?php echo get_permalink( get_page_by_title( 'Projects' ) ) . '#completed'; ?>">
                        Completed
                    </a>
                    <a class="inline-block font-foco-light text-[16px] text-white bg-aurora-blue-03 border-[5px] border-aurora-blue-03 rounded-full py-[5px] px-[30px] self-start transition-all duration-300 hover:transform hover:translate-y-1 hover:-translate-x-1 hover:shadow-inner hover:border-aurora-blue-02 cursor-pointer mr-[15px] my-[5px]"
	                    href="<?php echo get_permalink( get_page_by_title( 'Projects' ) ) . '#wip'; ?>">
                        Work in Progress
                    </a>
                    <a class="inline-block font-foco-light text-[16px] text-white bg-aurora-red-01 border-[5px] border-aurora-red-01 rounded-full py-[5px] px-[30px] self-start transition-all duration-300 hover:transform hover:translate-y-1 hover:-translate-x-1 hover:shadow-inner hover:border-aurora-blue-02 my-[5px]"
                       href="<?php echo get_permalink( get_page_by_title( 'Contact' ) ) . '#contact'; ?>">
                        Contact Us
                    </a>
                </div>
            </div>
