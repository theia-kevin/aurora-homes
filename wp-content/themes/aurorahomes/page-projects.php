...
get_header();
?>
    <div class="relative h-[650px] xl:h-[750px] mb-[50px] xl:mb-[100px] bg-cover bg-no-repeat" style="background-image: url('<?php echo get_theme_file_uri( '/images/AdobeStock_322912716 copy.jpg' ); ?>');">
    ...
    <div id="completed" class="relative mb-[100px] pb-[100px]" data-aos="fade-up" data-aos-once="true" data-aos-offset="-100" >
