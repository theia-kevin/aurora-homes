    ...
    <div class="container mx-auto mb-0 lg:mb-36 px-4 lg:px-0">
        <div class="grid grid-rows-2 grid-cols-12">
            <div class="col-span-4">
                ...
                <p class="font-light text-xl mb-8">118 Lincoln Road</p>
                <p class="font-light text-xl mb-8">Henderson</p>
                <p class="font-light text-xl">Email: info@auroradevelopment.co.nz</p>
                <p class="font-light text-xl mb-4">Phone: +64 (0)21 806 699</p>
                <div class="flex">
            ...
            <div class="row-span-2 col-span-8 relative">
                <div id="map" class="w-full h-full relative z-40"></div>
